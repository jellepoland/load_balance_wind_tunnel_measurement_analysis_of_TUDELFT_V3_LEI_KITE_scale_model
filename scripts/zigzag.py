...
def translateCoordsys(dataframe):
...
labbook_path = Path(root_dir) / "processed_data" / "zigzag" / "labbook_zz.csv"
labbook_df = pd.read_csv(labbook_path, delimiter=";")
...
def main(results_dir: str, root_dir: str) -> None:
    ...
    plot_zigzag_with_errors(root_dir, results_dir, fontsize, figsize)
