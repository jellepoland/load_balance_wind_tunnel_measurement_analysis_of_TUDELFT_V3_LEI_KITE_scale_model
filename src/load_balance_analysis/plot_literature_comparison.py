...
def plotting_polars_alpha_correction_comparison(
    ...
    colors = ["black", "black", "blue", "blue", "red"]
    linestyles = ["--", "-", "--", "-", "-"]
    markers = ["*", "*", "s", "s", "o"]
    fmt_wt = "o"
    ...
    # Save the plot
    plt.tight_layout()
    file_name = f"literature_polars_alpha_correction_vs_no_correction"
    saving_pdf_and_pdf_tex(results_dir, file_name)
...
#     label_1 = r"VSM  $\mathrm{Re} = 5.6 \times 10^5$"
#     colors = ["blue", "red"]
#     linestyles = ["-", "-"]
#     markers = ["s", "o"]

#     last_i = 1  # Default last index for confidence intervals
...
#         markers = ["s", "s", "o"]
#         last_i = 2
#     if "moment" in axs_titles[0]:
#         # is_with_label_0 = True
#         # label_0 = r"VSM $\mathrm{Re} = 5.6 \times 10^5$"
#         label_1 = r"VSM  $\mathrm{Re} = 5.6 \times 10^5$"
#         colors = ["blue", "red"]
#         linestyles = ["-", "-"]
#         markers = ["s", "o"]
...
#         if "WT" in label:
#             data_frame["beta"] = -data_frame["beta"]
...
def plot_single_row(
    ...
    # If the first label isn't a "special" one, drop the first legend entry
    # if "CFD" not in labels[0] or "no correction" not in labels[0]:
    # legend_elements = legend_elements[1:]
...
def plotting_polars_beta_moments(
    ...
    plot_single_row(
        ...
        linestyles=["--", "-", "-"],
        markers=["s", "s", "o"],
        file_name="moment_literature_polars_beta_high_alpha_correction_vs_no_correction",
        confidence_interval=confidence_interval,
    ...
    plot_single_row(
        ...
        linestyles=["--", "-", "-"],
        markers=["s", "s", "o"],
        file_name="moment_literature_polars_beta_low_alpha_correction_vs_no_correction",
        confidence_interval=confidence_interval,
